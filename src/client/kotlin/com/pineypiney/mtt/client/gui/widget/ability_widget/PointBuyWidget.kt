...
class PointBuyWidget(
	tab: AbilitiesTabWidget,
	x: Int,
	y: Int,
	w: Int,
	h: Int,
	val textColour: Int = MTTScreens.textColour
) : AbilitySelectorWidget(tab, x, y, w, h, Text.literal("Point Buy Widget")) {
	...
	override fun renderWidget(context: DrawContext, mouseX: Int, mouseY: Int, deltaTicks: Float) {
		...
		context.drawText(tab.client.textRenderer, labelText, x + (width - labelW) / 2, y, textColour, false)
		...
		context.drawText(tab.client.textRenderer, pointTallyText, x + (width - tallyW) / 2, y + 12, textColour, false)
		...
		for(i in 0..5){
			...
			context.drawText(tab.client.textRenderer, abilityText, x, y + 2, textColour, false)

			DynamicWidgets.drawThinBox(context, right - 50, y, 13, 13, baseColour, -1, -9605779)
			context.drawText(tab.client.textRenderer, abilityText, x, y + 2, textColour, false)
			if (hoveredButton == i * 2) context.drawStrokedRectangle(right - 50, y, 13, 13, -1)
			...
			if (hoveredButton == i * 2 + 1) context.drawStrokedRectangle(right - 13, y, 13, 13, -1)
			...
			context.drawText(tab.client.textRenderer, scoreText, right - 25 - scoreW / 2, y + 2, textColour, false)
		}
	}
