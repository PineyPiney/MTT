...
class BackgroundTabWidget(val client: MinecraftClient, x: Int, y: Int, width: Int, height: Int, message: Text, private val species: List<Species>) : ContainerWidget(x, y, width, height, message) {
