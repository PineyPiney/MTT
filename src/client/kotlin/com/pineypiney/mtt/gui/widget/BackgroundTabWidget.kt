...
class BackgroundTabWidget(sheet: CharacterSheet, client: MinecraftClient, x: Int, y: Int, width: Int, height: Int, message: Text, private val species: List<Species>) : CharacterCreatorTabWidget(
	sheet, client,
	x,
	y,
	width,
