...
class TestEntityRenderer(ctx: EntityRendererFactory.Context) : LivingEntityRenderer<TestEntity, DNDPlayerEntityRenderState, DNDPlayerEntityModel>(ctx, DNDPlayerEntityModel(ctx.getPart(MTTRenderers.BIPED_MODELS["default"]?.second)), .5f) {
