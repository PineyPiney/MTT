...
open class WeaponType(val id: String, val damageType: DamageType, val numDice: Int, val sides: Int, val martial: Boolean, val ranged: Boolean, val finesse: Boolean, val heavy: Boolean, val light: Boolean, val reach: Boolean, val twoHanded: Boolean, val versatile: Boolean, val nearDistance: Float, val farDistance: Float) {
	...
	companion object {
		...
		fun ranged(id: String, sides: Int, martial: Boolean, nearDistance: Float, farDistance: Float, finesse: Boolean = false, heavy: Boolean = false, light: Boolean = false, twoHanded: Boolean = false): WeaponType {
			val type = WeaponType(id, DamageType.PIERCING, 1, sides, martial, true, finesse, heavy, light, false, twoHanded, false, nearDistance, farDistance)
			return type.also { set.add(it) }
		}
		...
		val DAGGER = melee("dagger", DamageType.PIERCING, 1, 4, false, finesse = true, light = true, nearDistance = 4f, farDistance = 12f)
		val HAND_AXE = melee("hand_axe", DamageType.SLASHING, 1, 6, false, light = true, nearDistance = 4f, farDistance = 12f)
		val JAVELIN = melee("javelin", DamageType.PIERCING, 1, 6, false, nearDistance = 6f, farDistance = 24f)
		val LIGHT_HAMMER = melee("light_hammer", DamageType.BLUDGEONING, 1, 4, false, light = true, nearDistance = 4f, farDistance = 12f)
		...
		val SPEAR = melee("spear", DamageType.PIERCING, 1, 6, false, versatile = true, nearDistance = 4f, farDistance = 12f)
